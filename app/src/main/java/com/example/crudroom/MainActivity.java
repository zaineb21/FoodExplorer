...
import com.example.crudroom.Adapter.RecipeRVAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewmodal.getAllCourses().observe(this, new Observer<List<RecipeModal>>() {
            @Override
        ...
        adapter.setOnItemClickListener(new RecipeRVAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(RecipeModal model) {
                ...
                intent.putExtra(NewRecipeActivity.EXTRA_COURSE_NAME, model.getName());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_COURSE_REQUEST && resultCode == RESULT_OK) {
            String courseName = data.getStringExtra(NewRecipeActivity.EXTRA_COURSE_NAME);
            String courseDescription = data.getStringExtra(NewRecipeActivity.EXTRA_DESCRIPTION);
            String courseDuration = data.getStringExtra(NewRecipeActivity.EXTRA_DURATION);
            RecipeModal model = new RecipeModal(courseName, courseDescription, courseDuration);
            ...
            String courseName = data.getStringExtra(NewRecipeActivity.EXTRA_COURSE_NAME);
            String courseDesc = data.getStringExtra(NewRecipeActivity.EXTRA_DESCRIPTION);
            String courseDuration = data.getStringExtra(NewRecipeActivity.EXTRA_DURATION);
            RecipeModal model = new RecipeModal(courseName, courseDesc, courseDuration);
            model.setId(id);
